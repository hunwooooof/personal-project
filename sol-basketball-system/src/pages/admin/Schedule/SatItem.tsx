...
function SatItem({ schedule, quarter, year }: PropsType) {
  ...
  const renderTrashIcon = () => {
    return (
      <svg
        ...
        className='w-6 h-6 inline-block text-gray-300 cursor-pointer hover:text-red-400 fill-current'>
        <path
          fillRule='evenodd'
  ...
  const infoLabelClass = 'w-5 h-5 text-slate-600 inline mr-1 fill-current';
      ...
      <div className='w-11/12 pr-2 flex flex-col gap-2'>
        <div className='flex gap-3'>
          <div className='flex items-center w-36'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className={infoLabelClass}>
              <path
                fillRule='evenodd'
