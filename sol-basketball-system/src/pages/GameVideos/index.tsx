...
function GameVideos() {
  ...
  const inputClassSm = 'bg-slate-700 py-1 rounded-md w-36 px-2 placeholder:text-gray-500';
  const inputClassLg = 'bg-slate-700 py-1 rounded-md w-56 px-2 placeholder:text-gray-500';

  return (
    <div className='custom-main-container pt-16'>
      {user.role === 'admin' && (
        <div className='pb-14 mb-8 border-b border-gray-600'>
          <div className='w-10/12 mx-auto custom-page-title mb-4'>
            <div>Add Video</div>
          </div>
          <div className='w-10/12 mx-auto flex justify-between items-center p-8'>
            <div className='flex flex-col gap-3 font-bold'>
              ...
              <button
                className='w-32 mx-auto rounded-md text-blue-500  mt-4 py-1 hover:scale-110 duration-150 disabled:scale-100 disabled:cursor-not-allowed disabled:text-slate-700'
            ...
            <div className='p-4 border border-gray-600 shadow-md' id='video-demonstrate'>
              <iframe
              ...
              <div className='flex flex-col gap-2 mt-2'>
                <div className='flex justify-between items-center'>
                  ...
                  <div className='px-2 border border-gray-600 rounded-full'>
      ...
      <div className='w-10/12 mx-auto flex gap-5 items-center mb-6'>
        <div className='custom-page-title'>Top League</div>
        <select
          name='tag'
          id='tag'
          className='px-4 rounded-full py-1 bg-slate-800 font-bold border border-gray-600 text-white tracking-wide mt-1'
          onChange={(e) => {
      ...
      <div className='mb-5 w-full px-10 pt-10 pb-4 border-b border-gray-600'>
        <div className='w-10/12 mx-auto overflow-x-auto flex gap-6 pb-16 px-2'>
      ...
      <div className='w-10/12 mx-auto pb-20 pt-4'>
        <div className='custom-page-title mb-6'>Friendly Game</div>
        <div className='mb-5 w-full px-10 pt-10 pb-4'>
          <div className='overflow-x-auto flex gap-6 pb-8 px-2 w-full'>
